"""In this module you can choose and control character."""
...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку персонажа с учетом характеристик."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет блокировку урона персонажем с учетом характеристик."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Результат ввода attack, defence, special вызывает соответствующие функции.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора класса персонажа и назначение имени."""
    approve_choice: str = ''
    char_class: str = ''
